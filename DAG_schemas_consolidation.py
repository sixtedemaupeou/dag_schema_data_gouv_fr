...
from utils.geo import fix_coordinates_order
...
with DAG(
    ...
    clean_previous_outputs >> run_nb_consolidation >> improve_datasets_quality >> upload_consolidation >> notification_synthese
